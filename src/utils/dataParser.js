...
/**
 * Parse accelerometer data file grouped by device startup events
 * @param {string} fileContent - Raw text content of the file
 * @returns {Object} { movementEvents: Array, overallStats: Object }
 */
export function parseAccelFileByEvents(fileContent) {
  ...
  while (i < lines.length) {
    ...
    // Detect device startup - creates a new motion event
